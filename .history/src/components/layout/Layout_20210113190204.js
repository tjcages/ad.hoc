    ...
    return (
        <body className={css(styles.body)}>
            ...
            <section className={css(styles.events)}>
                <div className={css(styles.events_flex)} style={{display: 'grid'}}>
                    <span className={css(styles.subtitle)} style={{minHeight: '10px'}}>Now</span>
                ...
                <div className={css(styles.events_flex_upcoming)} style={{display: 'grid'}}>
