                ...
                {categories.map((category) => (
                    ...
                    <div className={css(styles.events_flex_upcoming)}>
                        ...
                        <div className={css(styles.block_upcoming)}>
                            <span className={css(styles.subtitle)} style={{paddingBottom: '8px'}}>10:30am</span>
                            <span className={css(styles.title2)}>Brainstorming session</span>
                            <span className={css(styles.text)}>Online • Work</span>
                        </div>
                    </div>
                    <div className={css(styles.events_flex_upcoming2)}>
                        <div className={css(styles.block_upcoming)}>
                            <span className={css(styles.subtitle)} style={{paddingBottom: '8px'}}>1:00pm</span>
                            <span className={css(styles.title2)}>Lunch @ Harbour</span>
                            <span className={css(styles.text)}>Denver • Personal</span>
                        </div>
                    </div>
                    <div className={css(styles.events_flex_upcoming2)}>
                        <div className={css(styles.block_upcoming)}>
                            <span className={css(styles.subtitle)} style={{paddingBottom: '8px'}}>2:00pm</span>
                            <span className={css(styles.title2)}>Tech sync</span>
                            <span className={css(styles.text)}>Online • Work</span>
                        </div>
                    </div>
                </section>
